...
public record ControllerState(
        ...
        short sTriggerL,
        short sTriggerR,
        float flTrustedGravityVectorX,
        float flTrustedGravityVectorY,
        float flTrustedGravityVectorZ,
        float flSoftwareQuatW,
        float flSoftwareQuatX,
        float flSoftwareQuatY,
        float flSoftwareQuatZ,
        float flSoftwareGyroDegreesPerSecondPitch,
        float flSoftwareGyroDegreesPerSecondYaw,
        float flSoftwareGyroDegreesPerSecondRoll,
        float flHardwareQuatW,
        float flHardwareQuatX,
        float flHardwareQuatY,
        float flHardwareQuatZ,
        float flHardwareGyroDegreesPerSecondPitch,
        float flHardwareGyroDegreesPerSecondYaw,
        float flHardwareGyroDegreesPerSecondRoll,
        float flGyroNoiseLength,
        float flGyroCalibrationProgress,
        float glGravityVectorX,
        float glGravityVectorY,
        float glGravityVectorZ,
